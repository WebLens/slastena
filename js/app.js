(() => {
    ...
    de(),
      document.querySelector(".reviews__slider") &&
        new oe(".reviews__slider", {
          ...
          speed: 800,
          navigation: {
            nextEl: ".pagination-reviews__next",
            prevEl: ".pagination-reviews__prev",
          },
          on: {},
        });
  });
  ...
  let pe = document.querySelector(".collector-tabs__content"),
    ue = pe.querySelectorAll("button"),
    he = document.querySelector(".collector__res").querySelector("span"),
    fe = document.querySelector(".collector__link"),
    me = 0;
  for (let e = 0; e < ue.length; e++)
    ue[e].addEventListener("click", () => {
      let t = ue[e].parentElement.parentElement
        .querySelector(".column-body-collector__price")
        .querySelector("span").innerText;
      (t = Number(t)),
        "number-minus" == ue[e].className && me >= t && (me -= t),
        "number-minus" != ue[e].className && (me += t),
        (he.innerText = me + " руб");
    }),
      fe.addEventListener("click", () => {
        (me = 0), (he.innerText = "0 руб");
        let e = pe.querySelectorAll("input");
        for (let t = 0; t < e.length; t++) e[t].value = 0;
      });
  (window.FLS = !0),
    (function (e) {
      let t = new Image();
